...
if __name__ == '__main__':
    ...
    loader = DataLoader(dataset, batch_size=1, shuffle=False, collate_fn=collate_fn, pin_memory=True)

    softmax = nn.Softmax(-1)
    save_path = pjoin('eval_results', opt.dataset_name, opt.name, 'test4')
